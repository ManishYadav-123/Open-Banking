...
class Bank2Users(models.Model):
    class Meta:
        verbose_name = "Punjab National Bank User"
        verbose_name_plural = "Punjab National Bank Users"
...
class Bank2Transactions(models.Model):
    class Meta:
        verbose_name = "Punjab National Bank Transaction"
        verbose_name_plural = "Punjab National Bank Transactions"
...
class Bank2LoanOffers(models.Model):
    class Meta:
        verbose_name = "Punjab National Bank Loan Offer"
        verbose_name_plural = "Punjab National Bank Loan Offers"
