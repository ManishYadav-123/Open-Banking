...
class Bank1Users(models.Model):
    class Meta:
        verbose_name = "State Bank of India User"
        verbose_name_plural = "State Bank of India Users"
...
class Bank1Transactions(models.Model):
    class Meta:
        verbose_name = "State Bank of India Transaction"
        verbose_name_plural = "State Bank of India Transactions"
...
class Bank1LoanOffers(models.Model):
    class Meta:
        verbose_name = "State Bank of India Loan Offer"
        verbose_name_plural = "State Bank of India Loan Offers"
