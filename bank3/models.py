...
class Bank3Users(models.Model):
    class Meta:
        verbose_name = "Union Bank of India User"
        verbose_name_plural = "Union Bank of India Users"
...
class Bank3Transactions(models.Model):
    class Meta:
        verbose_name = "Union Bank of India Transaction"
        verbose_name_plural = "Union Bank of India Transactions"
...
class Bank3LoanOffers(models.Model):
    class Meta:
        verbose_name = "Union Bank of India Loan Offer"
        verbose_name_plural = "Union Bank of India Loan Offers"
