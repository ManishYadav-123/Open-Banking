...
class Bank4Users(models.Model):
    class Meta:
        verbose_name = "Canara Bank User"
        verbose_name_plural = "Canara Bank Users"
...
class Bank4Transactions(models.Model):
    class Meta:
        verbose_name = "Canara Bank Transaction"
        verbose_name_plural = "Canara Bank Transactions"
...
class Bank4LoanOffers(models.Model):
    class Meta:
        verbose_name = "Canara Bank Loan Offer"
        verbose_name_plural = "Canara Bank Loan Offers"
